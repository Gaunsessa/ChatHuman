...
export default function InfoButton() {
  ...
  return (
    ...
    <button 
      ...
      className="w-18 h-18 rounded-[30] bg-[#e9e9e9] font-extrabold text-xl text-gray-300 flex items-center justify-center hover:bg-[#cbcbcb] hover:text-gray-500 hover:cursor-pointer transition"
    >
      ?
    </button>
        ...
        <div className="fixed inset-0 bg-[#00000070] flex items-center justify-center">
          <div className="bg-[#e9e9e9] p-6 rounded-2xl shadow-lg max-w-lg text-center">
            ...
            <button
              ...
              className="mt-4 bg-[#cbcbcb] text-red-900 px-4 py-2 rounded"
            >
              Return to the Fray
            </button>
          </div>
